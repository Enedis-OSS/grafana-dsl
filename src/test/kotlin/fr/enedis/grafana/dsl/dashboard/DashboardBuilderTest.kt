...
class DashboardBuilderTest {
    ...
    fun `should correct create minimal example`() {
        ...
        // that
        minimalDashboard.toString() shouldEqualToJson jsonFile("MinimalDashboard.json")
    }
    ...
    fun `should correct change time range`() {
        ...
        // that
        dashboard.toString() shouldEqualToJson jsonFile("DashboardWithTimeRange.json")
    }
    ...
    fun `should set uid`() {
        ...
        // that
        dashboard.toString() shouldEqualToJson jsonFile("DashboardWithUid.json")
    }
    ...
    fun `should set false to refresh property when refresh is off`() {
        ...
        // that
        dashboard.toString() shouldEqualToJson jsonFile("DashboardWithOffRefresh.json")
    }
    ...
    fun `should contains 2 tags when 1 tag added`() {
        ...
        // that
        dashboard.toString() shouldEqualToJson jsonFile("DashboardWithTags.json")
    }
    ...
    fun `should add panel to board when panels is called`() {
        ...
        // that
        dashboard.toString() shouldEqualToJson jsonFile("DashboardWithEmptyPanel.json")
    }
    ...
    fun `should add variable when variable is created`() {
        ...
        dashboard.toString() shouldEqualToJson jsonFile("DashboardWithVariable.json")
    }
    ...
    fun `should create an editable dashboard`() {
        ...
        // that
        dashboard.toString() shouldEqualToJson jsonFile("EditableDashboard.json")
    }
