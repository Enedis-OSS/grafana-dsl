 ...
 * @since 02.10.2022
 */
class BarGaugePanelFieldConfig(
...
/**
 * Builder for BarGaugePanelFieldConfiguration
 * @since 02.10.2022
 */
class BarGaugePanelFieldConfigBuilder(private val nullValueMode: NullValue = NullValue.NULL) {
    ...
    internal fun createBarGaugePanelFieldConfig(): BarGaugePanelFieldConfig = BarGaugePanelFieldConfig(
        unit,
        min,
        max,
        decimals,
